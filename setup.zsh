...
link alacritty/alacritty.yml $XDG_CONFIG_HOME/alacritty/alacritty.yml

mkdir -p $XDG_DATA_HOME/nvim/site/autoload
curl -sL https://raw.githubusercontent.com/junegunn/vim-plug/master/plug.vim > $XDG_DATA_HOME/nvim/site/autoload/plug.vim 
# run :PlugInstall
